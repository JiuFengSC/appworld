...
};
{
    ...
    "config": {
        "model_server": {
            "command": "vllm serve Qwen/Qwen3-8B --max-num-seqs 5 --max-model-len 40000 --enable-auto-tool-choice --tool-call-parser hermes --port {port}",
            "enabled": true,
            "show_logs": false,
            "timeout": 600
        },
