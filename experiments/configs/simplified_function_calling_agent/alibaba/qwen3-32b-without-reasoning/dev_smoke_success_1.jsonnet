...
};
{
    ...
    "config": {
        "model_server": {
            "command": "vllm serve Qwen/Qwen3-32B --max-num-seqs 5 --max-model-len 40000 --tensor-parallel-size 2 --enable-auto-tool-choice --tool-call-parser hermes --port {port}",
            "enabled": true,
            "show_logs": false,
            "timeout": 900
        },
        ...
        "dataset": "dev_smoke_success_1",
    },
    "metadata": {
        "model": {
            "file_name": "qwen3-32b-without-reasoning",
            "humanized_name": "Qwen3 32B Without Reasoning",
            "precise_name": "Qwen/Qwen3-32B",
            "creator": "alibaba",
            "provider": "vllm",
        },
        "agent": {
